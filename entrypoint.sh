...
grep -F "source /usr/share/gazebo-11/setup.bash" $BASHRC_PATH || echo "source /usr/share/gazebo-11/setup.bash" >> $BASHRC_PATH
...
grep -F "export TURTLEBOT3_MODEL=waffle_pi" $BASHRC_PATH || echo "export TURTLEBOT3_MODEL=waffle_pi" >> $BASHRC_PATH
grep -F "export DONT_PROMPT_WSL_INSTALL=1" $BASHRC_PATH || echo "export DONT_PROMPT_WSL_INSTALL=1" >> $BASHRC_PATH
grep -F "export DENO_INSTALL="/home/ubuntu/.deno"" $BASHRC_PATH || echo "export DENO_INSTALL="/home/ubuntu/.deno"" >> $BASHRC_PATH
grep -F "export PATH="$DENO_INSTALL/bin:$PATH"" $BASHRC_PATH || echo "export PATH="$DENO_INSTALL/bin:$PATH"" >> $BASHRC_PATH
grep -F "export PATH="$PATH:/usr/local/node-v20.17.0-linux-x64/bin"" $BASHRC_PATH || echo "export PATH="$PATH:/usr/local/node-v20.17.0-linux-x64/bin"" >> $BASHRC_PATH
